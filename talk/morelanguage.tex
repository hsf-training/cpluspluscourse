...
\begin{frame}[fragile]
  \frametitleii{Constant expressions with {\it if constexpr} (C++17)}
  \begin{block}{Notes}
    \begin{itemize}
    \item {\it if constexpr} requires a constant expression as condition
    \item it is evaluated at compile time
    \end{itemize}
  \end{block}
  \begin{cppcode*}{}
