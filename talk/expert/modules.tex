...
\begin{frame}[fragile]
    ...
    \begin{block}{Importable headers}
      ...
      \end{itemize}
      \item All \cpp20 headers are importable
  ...
  \begin{columns}
    ...
    \begin{column}{.6\textwidth}
      \begin{block}{Traditional workflow}
        \center
        \begin{tikzpicture}
          \draw [->](5,6) -- (5,0)  node [midway,right] {t};
          \draw[thick]
            node (vec)  at(3,6)   [rectangle,draw] {vector}
            node (hpp)  at(1,4.5) [rectangle,draw] {h.hpp}
            node (acpp) at(0,3)   [rectangle,draw] {a.cpp}
            node (bcpp) at(2,3)   [rectangle,draw] {b.cpp}
            node (ccpp) at(4,3)   [rectangle,draw] {c.cpp}
            node (ao)   at(0,1.5) [rectangle,draw] {a.o}
            node (bo)   at(2,1.5) [rectangle,draw] {b.o}
            node (co)   at(4,1.5) [rectangle,draw] {c.o}
            node (bin)  at(2,0)   [rectangle,draw] {binary};
          \draw[very thick,dotted,->] (vec)  -- (hpp)  node [midway,fill=white,rounded rectangle] {\#};
          \draw[very thick,dotted,->] (vec)  -- (bcpp) node [midway,fill=white,rounded rectangle] {\#};
          \draw[very thick,dotted,->] (vec)  -- (ccpp) node [midway,fill=white,rounded rectangle] {\#};
          \draw[very thick,dotted,->] (hpp)  -- (acpp) node [midway,fill=white,rounded rectangle] {\#};
          \draw[very thick,dotted,->] (hpp)  -- (bcpp) node [midway,fill=white,rounded rectangle] {\#};
          \draw[very thick,->] (acpp) -- (ao)   node [midway,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,->] (bcpp) -- (bo)   node [midway,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,->] (ccpp) -- (co)   node [midway,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,->] (ao)   -- (bin)  node [midway] {};
          \draw[very thick,->] (bo)   -- (bin)  node [midway,fill=white,rounded rectangle] {Linker};
          \draw[very thick,->] (co)   -- (bin)  node [midway] {};
  ...
  \begin{columns}
    ...
    \begin{column}{.6\textwidth}
      \begin{block}{New workflow}
        ...
        \begin{tikzpicture}
          \draw [->](7,10) -- (7,0)  node [midway,right] {t};
          ...
          \draw[very thick,dotted,->] (vec) -- (ccpp) node [midway,fill=white,rounded rectangle] {\#};
          \draw[very thick,->] (vec) -- (vecbmi) node [midway,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,dotted,->] (vecbmi) -- (hcpp) node [midway,fill=white,rounded rectangle] {imp};
          \draw[very thick,->] (hcpp) -- (hbmi) node [midway,fill=white,rounded rectangle] {};
          \draw[very thick,->] (hcpp) -- (ho) node [midway,right,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,dotted,->] (vecbmi) -- (bcpp) node [midway,fill=white,rounded rectangle] {imp};
          \draw[very thick,dotted,->] (hbmi) -- (acpp) node [midway,fill=white,rounded rectangle] {imp};
          \draw[very thick,dotted,->] (hbmi) -- (bcpp) node [midway,fill=white,rounded rectangle] {imp};
          \draw[very thick,->] (acpp) -- (ao) node [midway,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,->] (bcpp) -- (bo) node [midway,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,->] (ccpp) -- (co) node [midway,fill=white,rounded rectangle] {Compiler};
          \draw[very thick,->] (ho) to [bend right=30] (bin) node [midway] {};
          \draw[very thick,->] (ao) -- (bin) node [midway] {};
          \draw[very thick,->] (bo) -- (bin) node [midway,left,fill=white,rounded rectangle] {Linker};
          \draw[very thick,->] (co) to [bend left=30] (bin) node [midway] {};
        \end{tikzpicture}
        }
      \end{block}
    \end{column}
