...
\begin{frame}[fragile]
  ...
  \begin{block}{Default {\it <=>} implementation}
    \begin{itemize}
      \item We see above that the definition of {\it <=>} has been provided by the compiler, and the use of {\it <}  by {\it std::set} to sorts its elements has been rewritten by the compiler in terms of {\it <=>}.
