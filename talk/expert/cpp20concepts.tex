...
\begin{frame}[fragile]
    ...
    \begin{block}{Basic requirements}
      \begin{itemize}
        ...
        \item Below, we also require the existence of a trictly positive {\it epsilon}.
        \item There is no more need to require anything from the general case : the overload
        resolution will consider the second function as a better match if the requirements are fulfilled.
      \end{itemize}
    \end{block}
...
\begin{frame}[fragile]
    ...
    \begin{block}{Concepts}
      \begin{itemize}
        \item When a given set of requirements may be reused often, one may gather them in a concept.
      \end{itemize}
    \end{block}
...
\begin{frame}[fragile]
    ...
    \begin{block}{Within a function body}
      \begin{itemize}
        \item Concepts are also usable wherever a boolean is expected, including within a {\it if constexpr} condition, because they are evaluated at compile-time.
      \end{itemize}
    \end{block}
