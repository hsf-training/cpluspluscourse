...
\begin{frame}[fragile]
  ...
  \begin{block}{Motivation}
    ...
    \item As a last resort, template authors provide \textbf{documentation}, and practice tricky \textbf{template meta-programmation}.
...
\begin{frame}[fragile]
    ...
    \begin{block}{Basic requirements}
      \begin{itemize}
        ...
        \item Overload resolution consider the second function as a better match when the requirements are fulfilled.
      \end{itemize}
    \end{block}
