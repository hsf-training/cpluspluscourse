...
\begin{frame}[fragile]
  ...
  \begin{block}{On the heap}
    \begin{itemize}
    \item object are created by calling \mintinline{cpp}{new} (constructor is called)
    \item object are destructed by calling \mintinline{cpp}{delete} (destructor is called)
    \end{itemize}
  \end{block}
  \begin{cppcode}
    {
