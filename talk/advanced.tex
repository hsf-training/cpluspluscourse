...
\begin{frame}[fragile]
  \frametitleii{Method overriding}
  \begin{block}{Principle}
    \begin{itemize}
    \item a given method of the parent can be overriden in a child
    \item so that the behavior is adapted
...
\begin{frame}[fragile]
  ...
  To detect mistakes in the following code :
  ...
  \end{block}
  \begin{itemize}
  \item with \mintinline{cpp}|override|, you get a compiler error
...
\begin{frame}[fragile]
  \frametitlegb{Method overriding : which version is called ?}
  \begin{block}{the problem}
    \begin{itemize}
    \item a given method of the parent can be overriden in a child
    \item if you use polymorphism and see the child as a parent, which one is called ?
    \end{itemize}
  \end{block}
  \begin{multicols}{2}
    \begin{cppcode*}{gobble=2}
...
\begin{frame}[fragile]
  \frametitleii{\cpp11 makes the STL usable}
