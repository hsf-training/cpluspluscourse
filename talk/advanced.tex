...
\begin{frame}[fragile]
  ...
  \begin{alertblock}{Exercise Time}
    ...
    \item introduce an error in the code by droping ; at the end of a class
...
\begin{frame}[fragile]
  ...
  \begin{alertblock}{Exercise Time}
    ...
    \item run with --leak-check=full -> see details
...
\begin{frame}[fragile]
  ...
  \begin{alertblock}{Exercise Time}
    ...
    \item check that the issue whould have been trigger for MIN=20
    \end{itemize}
  \end{alertblock}
\end{frame}
