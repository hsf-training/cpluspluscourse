...
\begin{frame}[fragile]
  ...
  \begin{exercise}{memcheck}
    \begin{itemize}
    \item go to \texttt{exercises/memcheck}
    \item compile, run, it should work
...
\begin{frame}[fragile]
  ...
  \begin{exercise}{callgrind}
    \begin{itemize}
    \item go to \texttt{exercises/callgrind}
...
\begin{frame}[fragile]
  ...
  \begin{exercise}{helgrind}
    \begin{itemize}
    \item go to \texttt{exercises/helgrind}
    \item compile, run
