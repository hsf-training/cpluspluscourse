...
int main() {
  ...
  print( alwaysTrue || condition1 && condition2 );  // Q: Is this expressing useful?
  print( alwaysTrue && condition1 || condition2 );  // A: Not really. Since we use "true ||", it is always true.
